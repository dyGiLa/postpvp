...
ET.SubElement(ppoint, "PDataArray", type="Float32", Name="11", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float32", Name="l2", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float32", Name="l3", NumberOfComponents="1")
