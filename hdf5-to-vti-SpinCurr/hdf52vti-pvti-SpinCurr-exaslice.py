...
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="js11", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="js12", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="js13", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="js21", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="js22", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="js23", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="js31", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="js32", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="js33", NumberOfComponents="1")
