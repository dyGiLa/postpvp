...
# Declare point data arrays, Scalars="l1" tells ParaView to treat l1 as the default scalar.
ppoint = ET.SubElement(pimg, "PPointData", Scalars="l1")

ET.SubElement(ppoint, "PDataArray", type="Float64", Name="GradPhi1", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="GradPhi2", NumberOfComponents="1")
ET.SubElement(ppoint, "PDataArray", type="Float64", Name="GradPhi3", NumberOfComponents="1")
