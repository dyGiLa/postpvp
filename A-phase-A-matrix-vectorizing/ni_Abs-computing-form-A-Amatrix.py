...
calculator10.ResultArrayName = 'n2_Abs'
calculator10.Function = 'sqrt((((uv23^2)*(uv31^2)) + ((uv13^2)*((uv21^2) - (uv31^2))) - ((uv21^2)*(uv33^2)) + ((uv11^2)*(-(uv23^2) + (uv33^2))))/(((uv13^2)*(-(uv22^2)*(uv31^2) + (uv21^2)*(uv32^2))) + ((uv12^2)* ((uv23^2)*(uv31^2) - (uv21^2)*(uv33^2))) + ((uv11^2)*(-(uv23^2)*(uv32^2) + (uv22^2)*(uv33^2)))))'
...
calculator11.ResultArrayName = 'n3_Abs'
calculator11.Function = 'sqrt(((-(uv22^2)*(uv31^2)) + ((uv12^2)*(-(uv21^2) + (uv31^2))) + ((uv21^2)*(uv32^2)) + ((uv11^2)*((uv22^2) - (uv32^2))))/(((uv13^2)*(-(uv22^2)*(uv31^2) + (uv21^2)*(uv32^2))) + ((uv12^2)* ((uv23^2)*(uv31^2) - (uv21^2)*(uv33^2))) + ((uv11^2)*(-(uv23^2)*(uv32^2) + (uv22^2)*(uv33^2)))))'
...
calculator12.ResultArrayName = 'n1_Abs'
calculator12.Function = 'sqrt(((-(uv23^2)*(uv32^2)) + ((uv13^2)*(-(uv22^2) + (uv32^2))) + ((uv22^2)*(uv33^2)) + ((uv12^2)*((uv23^2) - (uv33^2))))/(((uv13^2)*(-(uv22^2)*(uv31^2) + (uv21^2)*(uv32^2))) + ((uv12^2)* ((uv23^2)*(uv31^2) - (uv21^2)*(uv33^2))) + ((uv11^2)*(-(uv23^2)*(uv32^2) + (uv22^2)*(uv33^2)))))'
