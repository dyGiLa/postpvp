...
piopvti = XMLPartitionedUnstructuredGridReader(registrationName='pio.pvtu', FileName=['./pio.pvti'])
piopvti.PointArrayStatus = ['gapA', 'u11', 'u12', 'u13', 'u21', 'u22', 'u23', 'u31', 'u32', 'u33',
...
dMNLAphaseAmatrixFilter1 = DMNLAphaseAmatrixFilter(registrationName='DMNLAphaseAmatrixFilter1', Input=piopvti)
